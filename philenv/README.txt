NOTES LORS DU TRANSFERT SUR GITHUB LE 25 JUIN 2023 = comme j'ai fait un peu de cleaning, ce serait sans doute plus simple de tout agréger dans le zshrc, plutôt que de maintenir un projet séparé.

================================================================================
Pour installer le philenv sur une machine :
================================================================================
    1. Appeler ./release.sh
    2. En root, copier le répertoire créé dans "/opt"
    3. Le rendre accessible en lecture et exécution à tout le monde, récursivement :

        sudo chmod -R o+rx RELEASED_philenv.d_14décembre2013_11h08m30s
